...
final class Version20201223080701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('UPDATE role SET permissions = '.Permission::get(Permission::PROJECT_VIEW_OWN | Permission::PROJECT_CREATE | Permission::USER_VIEW_SELF | Permission::USER_EDIT_SELF)->getValue().' WHERE name LIKE "ROLE_USER"');
    }
