...
final class Version20201223080701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('UPDATE role SET permissions = '.Permission::get(Permission::PROJECT_VIEW | Permission::PROJECT_CREATE | Permission::USER_VIEW | Permission::USER_EDIT | Permission::TEAM_CREATE)->getValue().' WHERE name LIKE "ROLE_USER"');
    }
