...
namespace App\Tests\Modules\UserManagement\ApiPlatform\Filter;
...
class UserEmailFilterTest extends APITestCase
{
    ...
    public function testItAllowsToSearchUsersOfSameTeamsViaPartialEmail(): void
    {
        $this->createUser('first@test.com', 'first', 'user');
        $this->createUser('second@test.com', 'second', 'user');
        $this->createUser('third@test.com', 'third', 'user');
        ...
        $response = $this->graphql($listUsersQuery, ['email' => 'third']);
